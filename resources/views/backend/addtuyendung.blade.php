...
<div class="container-fluid">
  ...
  <form action="{!!url('admin/tuyendung/add')!!}" method="post" accept-charset="utf-8" enctype="multipart/form-data" >
    <h3>Tiêu đề :</h3>
    <input required type="text" name="tdtieude" id="input" class="form-control" value="" >
  <h3>Nội Dung</h3>
  <textarea class="ckeditor" required name="tdnoidung"></textarea>
<!--     <script type="text/javascript">
  ...
  <h3>Slug :</h3>
  <input required type="text" name="tdslug" id="input" class="form-control" value="">
