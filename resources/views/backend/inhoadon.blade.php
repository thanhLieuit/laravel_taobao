...
<body onload="window.print();">
    ...
    <table>
          @foreach($chitietuser as $chitietuser)
          <tr>
            <td>Mã vận đơn :</td>
            <td>{{$chitietuser->madonvan}}</td>
        </tr>
        <tr>
    ...
    <table class="table  table-hover">
        ...
        <tr>
            ...
            <th style="font-weight: bold;color: #EB4D4B;">{{$sum}}</th>
        </tr>
        </thead>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="ttnh">
                ...
                <p>số điện thoại: <span>{{$chitietuser->sodienthoai}}</span></p>
