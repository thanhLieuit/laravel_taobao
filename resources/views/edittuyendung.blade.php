                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav mr-auto mt-md-0 ">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted text-muted waves-effect waves-dark" href="form-addons.html" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="mdi mdi-message"></i>
                        ...
                        <!-- ============================================================== -->
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="form-addons.html" id="2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="mdi mdi-email"></i>
                                <div class="notify"> <span class="heartbit"></span> <span class="point"></span> </div>
                            </a>
                        ...
                        <!-- Messages -->
                        <!-- ============================================================== -->
                        <li class="nav-item dropdown mega-dropdown"> <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="form-addons.html" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="mdi mdi-view-grid"></i></a>
                                ...
                                <ul class="mega-dropdown-menu row">
                                    <li class="col-lg-3 col-xlg-2 m-b-30">
                                        ...
                                        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                            ...
                                            <a class="carousel-control-prev" href="form-addons.html#carouselExampleControls" role="button" data-slide="prev"> <span class="carousel-control-prev-icon" aria-hidden="true"></span> <span class="sr-only">Previous</span> </a>
                                            <a class="carousel-control-next" href="form-addons.html#carouselExampleControls" role="button" data-slide="next"> <span class="carousel-control-next-icon" aria-hidden="true"></span> <span class="sr-only">Next</span> </a>
                                        </div>
                                        <!-- End CAROUSEL -->
                                    </li>
                                        ...
                                        <div id="accordion" class="nav-accordion" role="tablist" aria-multiselectable="true">
                                            <div class="card">
                                                <div class="card-header" role="tab" id="headingOne">
                                                    <h5 class="mb-0">
                                                <a data-toggle="collapse" data-parent="#accordion" href="form-addons.html#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                            ...
                                            <div class="card">
                                                <div class="card-header" role="tab" id="headingTwo">
                                                    <h5 class="mb-0">
                                                <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="form-addons.html#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                            ...
                                            <div class="card">
                                                <div class="card-header" role="tab" id="headingThree">
                                                    <h5 class="mb-0">
                                                <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="form-addons.html#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="form-addons.html" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="../assets/images/users/1.jpg" alt="user" class="profile-pic" /></a>
                            <div class="dropdown-menu dropdown-menu-right animated flipInY">
                                <ul class="dropdown-user">
                                    ...
                                    <li><a href="form-addons.html#"><i class="ti-user"></i> My Profile</a></li>
                                    <li><a href="form-addons.html#"><i class="ti-wallet"></i> My Balance</a></li>
                                    <li><a href="form-addons.html#"><i class="ti-email"></i> Inbox</a></li>
                                    <li role="separator" class="divider"></li>
                                    <li><a href="form-addons.html#"><i class="ti-settings"></i> Account Setting</a></li>
                                    <li role="separator" class="divider"></li>
                                    <li><a href="form-addons.html#"><i class="fa fa-power-off"></i> Logout</a></li>
                                </ul>
                            </div>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="form-addons.html" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="flag-icon flag-icon-us"></i></a>
                            <div class="dropdown-menu  dropdown-menu-right animated bounceInDown"> <a class="dropdown-item" href="form-addons.html#"><i class="flag-icon flag-icon-in"></i> India</a> <a class="dropdown-item" href="form-addons.html#"><i class="flag-icon flag-icon-fr"></i> French</a> <a class="dropdown-item" href="form-addons.html#"><i class="flag-icon flag-icon-cn"></i> China</a> <a class="dropdown-item" href="form-addons.html#"><i class="flag-icon flag-icon-de"></i> Dutch</a> </div>
                        </li>
                    </ul>
                </div>
            </nav>
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <div class="user-profile">
                    ...
                    <!-- User profile text-->
                    <div class="profile-text"> <a href="form-addons.html#" class="dropdown-toggle link u-dropdown" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true">Markarn Doe <span class="caret"></span></a>
                        <div class="dropdown-menu animated flipInY">
                            <a href="form-addons.html#" class="dropdown-item"><i class="ti-user"></i> My Profile</a>
                            <a href="form-addons.html#" class="dropdown-item"><i class="ti-wallet"></i> My Balance</a>
                            <a href="form-addons.html#" class="dropdown-item"><i class="ti-email"></i> Inbox</a>
                            <div class="dropdown-divider"></div> <a href="form-addons.html#" class="dropdown-item"><i class="ti-settings"></i> Account Setting</a>
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li>
                            <a class="has-arrow" href="form-addons.html#" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="hide-menu">Dashboard <span class="label label-rounded label-success">5</span></span></a>
                        ...
                        <li>
                            <a class="has-arrow " href="form-addons.html#" aria-expanded="false"><i class="mdi mdi-bullseye"></i><span class="hide-menu">Apps</span></a>
                            <ul aria-expanded="false" class="collapse">
                        ...
                        <li>
                            <a class="has-arrow " href="form-addons.html#" aria-expanded="false"><i class="mdi mdi-email"></i><span class="hide-menu">Inbox</span></a>
                            <ul aria-expanded="false" class="collapse">
                        ...
                        <li>
                            <a class="has-arrow" href="form-addons.html#" aria-expanded="false"><i class="mdi mdi-chart-bubble"></i><span class="hide-menu">Ui Elements</span></a>
                            <ul aria-expanded="false" class="collapse">
                        ...
                        <li>
                            <a class="has-arrow" href="form-addons.html#" aria-expanded="false"><i class="mdi mdi-file"></i><span class="hide-menu">Forms</span></a>
                            <ul aria-expanded="false" class="collapse">
                        ...
                        <li>
                            <a class="has-arrow " href="form-addons.html#" aria-expanded="false"><i class="mdi mdi-table"></i><span class="hide-menu">Tables</span></a>
                            <ul aria-expanded="false" class="collapse">
                        ...
                        <li>
                            <a class="has-arrow " href="form-addons.html#" aria-expanded="false"><i class="mdi mdi-widgets"></i><span class="hide-menu">Widgets</span></a>
                            <ul aria-expanded="false" class="collapse">
                        ...
                        <li>
                            <a class="has-arrow " href="form-addons.html#" aria-expanded="false"><i class="mdi mdi-book-multiple"></i><span class="hide-menu">Page Layout</span></a>
                            <ul aria-expanded="false" class="collapse">
                        ...
                        <li>
                            <a class="has-arrow " href="form-addons.html#" aria-expanded="false"><i class="mdi mdi-book-open-variant"></i><span class="hide-menu">Sample Pages</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="starter-kit.html">Starter Kit</a></li>
                                <li><a href="pages-blank.html">Blank page</a></li>
                                <li><a href="form-addons.html#" class="has-arrow">Authentication <span class="label label-rounded label-success">6</span></a>
                                    <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="form-addons.html#" class="has-arrow">Error Pages</a>
                                    <ul aria-expanded="false" class="collapse">
                        ...
                        <li>
                            <a class="has-arrow " href="form-addons.html#" aria-expanded="false"><i class="mdi mdi-file-chart"></i><span class="hide-menu">Charts</span></a>
                            <ul aria-expanded="false" class="collapse">
                        ...
                        <li>
                            <a class="has-arrow " href="form-addons.html#" aria-expanded="false"><i class="mdi mdi-brush"></i><span class="hide-menu">Icons</span></a>
                            <ul aria-expanded="false" class="collapse">
                        ...
                        <li>
                            <a class="has-arrow " href="form-addons.html#" aria-expanded="false"><i class="mdi mdi-map-marker"></i><span class="hide-menu">Maps</span></a>
                            <ul aria-expanded="false" class="collapse">
                        ...
                        <li>
                            <a class="has-arrow " href="form-addons.html#" aria-expanded="false"><i class="mdi mdi-arrange-send-backward"></i><span class="hide-menu">Multi level dd</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="form-addons.html#">item 1.1</a></li>
                                <li><a href="form-addons.html#">item 1.2</a></li>
                                <li>
                                    <a class="has-arrow" href="form-addons.html#" aria-expanded="false">Menu 1.3</a>
                                    <ul aria-expanded="false" class="collapse">
                                        <li><a href="form-addons.html#">item 1.3.1</a></li>
                                        <li><a href="form-addons.html#">item 1.3.2</a></li>
                                        <li><a href="form-addons.html#">item 1.3.3</a></li>
                                        <li><a href="form-addons.html#">item 1.3.4</a></li>
                                    </ul>
                                </li>
                                <li><a href="form-addons.html#">item 1.4</a></li>
                            </ul>
                        </li>
                    </ul>
                </nav>
            ...
            <div class="sidebar-footer">
                <!-- item-->
                <a href="form-addons.html" class="link" data-toggle="tooltip" title="Settings"><i class="ti-settings"></i></a>
                <!-- item-->
                <a href="form-addons.html" class="link" data-toggle="tooltip" title="Email"><i class="mdi mdi-gmail"></i></a>
                <!-- item-->
                <a href="form-addons.html" class="link" data-toggle="tooltip" title="Logout"><i class="mdi mdi-power"></i></a>
            </div>
            <!-- End Bottom points-->
        </aside>
        <!-- ============================================================== -->
                ...
                <div class="row page-titles">
                    ...
                    <div class="col-md-6 col-4 align-self-center">
                        ...
                        <div class="dropdown pull-right m-r-10 hidden-sm-down">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton"> <a class="dropdown-item" href="form-addons.html#">February 2017</a> <a class="dropdown-item" href="form-addons.html#">March 2017</a> <a class="dropdown-item" href="form-addons.html#">April 2017</a> </div>
                        </div>
                    </div>
                </div>
                <!-- ============================================================== -->
                                            ...
                                            <div class="form-group m-b-0">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="input-group-btn">
                                                        ...
                                                        <div class="dropdown-menu"> <a class="dropdown-item" href="form-addons.html#">Action</a> <a class="dropdown-item" href="form-addons.html#">Another action</a> <a class="dropdown-item" href="form-addons.html#">Something else here</a>
                                                            <div class="dropdown-divider"></div> <a class="dropdown-item" href="form-addons.html#">Separated link</a> </div>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
                            ...
                            <div class="card-block">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-xlg-4">
                                        ...
                                        <div class="button-box m-t-20"> <a id="select-all" class="btn btn-danger" href="form-addons.html#">select all</a> <a id="deselect-all" class="btn btn-info" href="form-addons.html#">deselect all</a> <a id="add-option" class="btn btn-success" href="form-addons.html#">Add option</a> <a id="refresh" class="btn btn-warning" href="form-addons.html#">refresh</a> </div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-block">
                                ...
                                <div class="row">
                                    <div class="col-xlg-2 col-lg-4 col-md-6 col-xs-12">
                                        <h4 class="card-title m-t-40">Checkbox Square</h4>
                                        <h6 class="card-subtitle m-b-30"> Bootstrap brand colors </h6>
                                        <div class="checkbox">
                                    ...
                                    <div class="col-xlg-2 col-lg-4 col-md-6 col-xs-12">
                                        <h4 class="card-title m-t-40">Checkbox Circle</h4>
                                        <h6 class="card-subtitle m-b-30">Add simple <code>checkbox-circle</code> class </h6>
                                    ...
                                    <div class="col-xlg-2 col-lg-4 col-md-6 col-xs-12">
                                        <h4 class="card-title m-t-40">Checkbox Disable</h4>
                                        <h6 class="card-subtitle m-b-30"> Disable state </h6>
                                        <div class="checkbox">
                                    ...
                                    <div class="col-xlg-2 col-lg-4 col-md-6 col-xs-12">
                                        <h4 class="card-title m-t-40">Radio Buttons</h4>
                                        <h6 class="card-subtitle m-b-30"> With bootstrap colors </h6>
                                        <div class="radio">
                                    ...
                                    <div class="col-xlg-2 col-lg-4 col-md-6 col-xs-12">
                                        <h4 class="card-title m-t-40">Radio Clickable</h4>
                                        <h6 class="card-subtitle m-b-30"> All buttons clickable </h6>
                                        <div class="radio">
                                    ...
                                    <div class="col-xlg-2 col-lg-4 col-md-6 col-xs-12">
                                        <h4 class="card-title m-t-40">Radio Disable</h4>
                                        <h6 class="card-subtitle m-b-30"> Disable state </h6>
                                        <div class="radio">
