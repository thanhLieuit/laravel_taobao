...
@section('main')
@section('title','Danatao | Hướng dẫn tìm kiếm sản phẩm')
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-8 hd2">
					<div class="hinh" >
						<img src="{!!url('img/tk1.png')!!}" alt="">
						<br>
						<br>
						<img src="{!!url('img/tk2.png')!!}" alt="">
						<br>
						<br>
						<img src="{!!url('img/tk3.png')!!}" alt="">
						<br>
						<br>
						<img src="{!!url('img/tk4.png')!!}" alt="">
					</div>
				</div>
			</div>
		</div>
