...
<div class="element03">
	<div class="container">
		<h1>tin tức <i class="fa fa-angle-right" aria-hidden="true"></i> <span style="font-size: 20px;">kinh doanh <i class="fa fa-angle-right" aria-hidden="true"></i></span><span style="font-size: 14px">{{$laytin->tieude}}</span></h1>
		<center>
		...
		<div class="row">
			<div class="col-md-9">
				...
				<div class="chitiettintuc3" style="padding-top: 50px">
					<p style="text-align: justify;">{!!$laytin->noidung!!}</p>
				</div>
			</div>
