...
<div class="element03">
	<div class="container">
		<h1><h1>tin tức <i class="fa fa-angle-right" aria-hidden="true"></i> <span style="font-size: 20px;">kinh doanh </h1>
		<center>
						<div class="hinhthan hinhthan1"><p>Trang chủ  <i class="fa fa-angle-right" aria-hidden="true"></i> tin tức  <i class="fa fa-angle-right" aria-hidden="true"></i> Kinh doanh</p></div>
	</div>
		</center>
</div>
<section>
	<div class="container tieude">
		<h3 style="text-transform: uppercase;text-align: center;"><a style="border-bottom: 3px solid #707070;"  href="{!!url('/tintuc/kinhdoanh')!!}">kinh doanh </a>| <a href="{!!url('/tintuc/giaidap')!!}">giải đáp thắc mắc</a> | <a href="{!!url('/tintuc/congty')!!}">tin tức công ty</a> </h3>
		<div class="row">
			<div class="col-md-9 ttkd">

				@foreach($laykd as $laykds)
					<a class="dskd" href="{!!url('tintuc/kinhdoanh')!!}/{{$laykds->slug}}">
						<div class="row">
							<div class="col-md-4 ttkd3">
								 <img src="../img/{{ $laykds->img }}" alt="">
							</div>
							<div class="col-md-8 ttkd4">
								<h3>{{$laykds->tieude}}</h3>
								<p><i class="fa fa-calendar" aria-hidden="true"></i> {{$laykds->updated_at}} &nbsp;&nbsp;</p> 
								<hr>
								<p>{{ $laykds->noidungtt }}</p>
							</div>
						</div>
					</a>
					@endforeach
