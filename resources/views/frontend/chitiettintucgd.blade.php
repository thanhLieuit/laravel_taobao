...
<div class="element03">
	<div class="container">
		<h1>tin tức <i class="fa fa-angle-right" aria-hidden="true"></i> <span style="font-size: 20px;"> giải đáp thắc mắc <i class="fa fa-angle-right" aria-hidden="true"></i></span><span style="font-size: 14px">{{$laytingd->tieude}}</span></h1>
		<center>
		...
		<div class="row">
			<div class="col-xs-9 col-sm-9 col-md-9 col-lg-9 ">
				<div class="chitiettintuc3" style="padding-top: 50px">
					<p style="text-align: justify;">{!!$laytingd->noidung!!}</p>
				</div>
			</div>
			<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 chitiettintuc4 tintuc2">
