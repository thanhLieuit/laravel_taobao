...
<div class="element03">
	<div class="container">
		<h1>Liên hệ</h1>
		<center>
			<div class=" hinhthan"><p>Trang chủ <i class="fa fa-angle-right" aria-hidden="true"></i> liên hệ</p></div>
...
<section style="" >
	<div class="lienhe1">
		<div class="container">
			<div class="row">
				<div class="col-md-8">
					<h2>Phản hồi  <span style="color:#EC6563 ">ý kiến</span></h2><br>
					  ...
					  <h4 >Tiêu đề</h4>
					  <input style="width: 100%; height:40px;border-radius: 20px;width:100%;padding-left: 20px;font-size: 16px " type="text" name="td" value="" placeholder="">   <br>
					  <h4 >Nội dung</h4>
